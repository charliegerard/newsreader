...
#u1 = User.create(:first_name => "Charlie", :last_name => "Gerard", :email_address => "annecharlotte.gerard@gmail.com", :photo => "http://m.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/4/005/048/342/17f9554.jpg")
